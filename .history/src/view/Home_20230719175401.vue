        ...
        <el-row>
            ...
            <el-col :span="16" style="padding-left: 10px;">
                <div class="num">
                    ...
                    <el-card style="height: 280px; width: 100%;" ref=""></el-card>
                    <div class="chart">
...
export default {
    ...
    mounted() {
        ...
        echarts1soption.lengnd = {
            data:xAxis
        }
        echarts1soption.series =[]
        xAxis.array.forEach(element => {
            push
        });({
            echarts1soption.series.forEach({
            name:key,
            data:orderData.data.forEach(element => {
