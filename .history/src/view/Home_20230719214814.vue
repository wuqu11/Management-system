    ...
    <div>
        <el-row>
            ...
            <el-col :span="16" style="padding-left: 10px;">
                ...
                <el-card style="height: 280px; width: 100%;" class="echarts1"></el-card>
                <div class="chart">
...
export default {
    ...
    mounted() {
        getData().then((data) => {
            ...
            const echarts1 = echarts.init(document.getElementById('echar'))

            var echarts1soption = {}

            const { orderData } = data.data.data
            const xAxis = Object.keys(orderData.data[0])
            echarts1soption.xAxis = xAxis
            echarts1soption.legend = {
                data: xAxis
            }
