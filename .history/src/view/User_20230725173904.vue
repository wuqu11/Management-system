<template>
    <div class="user">
        <el-dialog title="提示" :visible.sync="dialogVisible" width="50%">
            ...
            <el-form ref="form" :inline="true" label-width="80px" :rules="rules" :model="form" :before-close="handleClose">
                ...
                <el-form-item label="性别" prop="sex">
                    <el-select v-model="form.sex" placeholder="请选择"  style="width: 300%;>
        ...
        <div class="user-header">
            <el-button @click="handerAdd" type="primary">
                + 新增
            </el-button>
        </div>
        <!-- 显示mock.js带来的信息 -->
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="addr" label="操作">
                <el-button class="handeredit" @click="handeredit">编辑</el-button>
                <el-button class="handerdel" type="danger" @click="handereclear(row)">删除</el-button>
            </el-table-column>
        </el-table>
    </div>
</template>
