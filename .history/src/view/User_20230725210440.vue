<template>
    <div class="user">
        ...
        <div class="manage-header">
            ...
            <el-form :inline="true" :model="Userform" style="right: 0;">
            <el-form-item >
        ...
        <div class="comm-total">
            ...
            <el-table :data="tableData" stripe style="width: 100%" height="95%" :stripe="true">
                ...
                <el-table-column prop="age" label="年龄" width="210">
                </el-table-column>
                <el-table-column prop="birth" label="日期" width="210">
                </el-table-column>
            ...
            <div class="page">
                <el-pagination layout="prev, pager, next" :total="pagetotal" @current-change="changepage" :value="123">
                </el-pagination>
            </div>
        </div>
    </div>
