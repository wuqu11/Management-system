<template>
    <div class="user">
        <el-dialog title="提示" :visible.sync="dialogVisible" width="50%">
            <!-- 用户表单 -->
            <el-form ref="form" :inline="true" label-width="80px" :rules="rules" :model="form" :before-close="handleClose" height="90%">
        ...
        <!-- 显示mock.js带来的信息 -->
        <el-table :data="tableData" stripe style="width: 100%" height>
